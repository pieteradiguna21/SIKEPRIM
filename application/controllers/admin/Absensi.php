...
class Absensi extends CI_Controller {
	...
	public function index()
	{
		...
		$data['subtitle']	= 'Data presensi akan ditampilkan disini';
	...
	{
		$this->session->set_flashdata('pesan', 'Anda sudah presensi masuk');
	...
	{
		$this->session->set_flashdata('pesan', 'Anda sudah presensi pulang');
		redirect('admin/absensi');
	}
