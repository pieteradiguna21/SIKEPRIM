                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td><?= $row['shift'] ?></td>
                                    <td><?= date('H:i:s', strtotime($row['jamMasuk'])) . ' - ' . date('H:i:s', strtotime($row['jamPulang'])) ?></td>
                                    <td><?= $row['status'] ?></td>
                                    ...
                                    <td>
                                        <?php if($this->session->userdata('level') == 'Administrator') { ?>
                                            ...
                                            <a href="<?= base_url('index.php/admin/shift/delete/').$row['id'] ?>" class="btn btn-danger btn-xs tombol-yakin" data-isidata="Ingin manghapus data ini?">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="time" name="jamMasuk" class="form-control" placeholder="Jam Masuk" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Jam Pulanng</label>
                                <input type="time" name="jamPulang" class="form-control" placeholder="Jam Pulanng" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <form action="<?= base_url('index.php/admin/shift/update/').$edit->id ?>" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nama Shift</label>
                            <input type="text" name="shift" class="form-control" value="<?= $edit->shift ?>" placeholder="Nama Shift" required>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Jam Masuk</label>
                                    <input type="time" name="jamMasuk" class="form-control" value="<?= $edit->jamMasuk ?>" placeholder="Jam Masuk" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Jam Pulanng</label>
                                    <input type="time" name="jamPulang" class="form-control" value="<?= $edit->jamPulang ?>" placeholder="Jam Pulanng" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
