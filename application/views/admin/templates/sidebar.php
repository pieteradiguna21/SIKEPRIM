      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MAIN NAVIGATION</li>
          ...
          <?php if($this->session->userdata('level') == 'Administrator') { ?>
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?= base_url('index.php/admin/kewajiban') ?>"><i class="fa fa-circle-o"></i> Data Kewajiban Presensi</a></li>
              </ul>
            </li>
          <?php } ?>
          <li>
            <a href="<?= base_url('index.php/admin/absensi') ?>">
              <i class="fa fa-edit"></i> <span>Data Presensi</span>
            </a>
          </li>
          ...
          <?php if($this->session->userdata('level') == 'Administrator') { ?>
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-cogs"></i> <span>Kelola Data Pegawai</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
